...
class BranchCustomize {
   ...
   public static function register( $wp_customize ) {
	  ...
	  $wp_customize->add_setting( 'skin', //No need to use a SERIALIZED name, as `theme_mod` settings already live under one db record
		 array(
	  ...
	  $options = array();
	  foreach(BranchSkin::get_skins() as $skin) {
	  ...
	  $wp_customize->get_setting( 'skin' )->transport = 'postMessage';
   }
   ...
   public static function header_output() {
   	  return false;// don't want this yet
	  ?>
	  <!--Customizer CSS--> 
	  <style type="text/css">
